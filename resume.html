            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/Capa.jpg" alt="Thomas Frankliyn Sena Santos">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Thomas Frankliyn Sena Santos</h4>
                        <div class="status">Graduando em Sistemas de Informação</div>
                        <ul class="header__social">

                            <li>
                                <a href="https://github.com/ThomasFrankliyn">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/UCG6j0V1f2sqLYDWEXbNGf5w?view_as=subscriber">
                ...
                <div class="header__right">
                    <ul class="header__contact">
                        <li>
                            ...
                            ThomasFrankliyn.comercial@contato.com.br
                        </li>
                        <li>
                            ...
                            <div class="col-12">
                                ...
                                <div class="timeline">
                                    ...
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Ensino Médio</h5>
                                        <span class="timeline__period">2007 — 2009</span>
                                        <p class="timeline__description">
                                            Colégio Estadual Abdias Menezes</p>
                                    </article>

                                    <!-- Item -->
                                    <article class="timeline__item">
                                        <h5 class="title title--h5 timeline__title">Técnico em Informática
                                        </h5>
                                        <span class="timeline__period">2009 — 2012</span>
                                        <p class="timeline__description">Instituto Federal da Bahia</p>
                                    </article>
                                    ...
                                    <article class="timeline__item">
                                        ...
                                        <p class="timeline__description">Universal Informática</p>
                                        <ul>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="timeline">
                                            <!-- Item -->
                                            <article class="timeline__item">
                                                <h5 class="title title--h5 timeline__title">Tecnico em Informática</h5>
                                                <span class="timeline__period">2013 — 2015</span>
                                                <p class="timeline__description">Fazer manutenção Pc's e notebooks</p>
                                            </article>
                                            <!-- Item -->
                                            <article class="timeline__item">
                                                <h5 class="title title--h5 timeline__title">Assistente Adminstrativo
                                                </h5>
                                                <span class="timeline__period">2016 — Presente</span>
                                                <p class="timeline__description">Atendimento ao público, organizar e
                                        ...
                                        <div class="box box__border">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="60"
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-text"><span>WordPress</span><span>60%</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="40"
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-text"><span>JavaScript</span><span>40%</span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="40"
                                                    aria-valuemin="0" aria-valuemax="100">
                                                    <div class="progress-text"><span>Node.js</span><span>30%</span>
                                                    </div>
                                                </div>
