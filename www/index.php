                ...
                <div class="col-12 col-md-12 col-lg-10">
                    <div class="box box-content">
                        ...
                        <div class="pb-0 pb-sm-2">
                            ...
                            <p>Iniciei meus estudos de na área de informática, aos 13 anos com um curso básico,
                                    ...
                                    <div class="swiper-container js-carousel-clients">
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/MGInformática.jpeg"
                                                        style="background-color: #FFF;" alt="MG Informática Logo" /></a>
                                            </div>

                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/pereira.jpeg"
                                                        style="background-color: #FFF;" alt="Pereira Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#"><img src="assets/img/Starcolor.jpeg"
                                                        style="background-color: #FFF;" alt="Starcolor Logo" /></a>
                                            </div>
                                            <!-- Item client -->
                                            <div class="swiper-slide">
                                                <a href="#">
                                                    <img src="assets/img/Dellamama.jpeg" style="background-color: #FFF;"
                                                        alt="Della Mama Logo" /></a>
                                            </div>
