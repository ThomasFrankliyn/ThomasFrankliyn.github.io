        ...
        <div class="container gutter-top">
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/Capa.jpg" alt="Iury Gomes de Oliveira">
                    </div>
            ...
            <div class="row sticky-parent">
                ...
                <div class="col-12 col-md-12 col-lg-10">
                        ...
                        <div class="pb-0">
                            ...
                            <div class="gallery-grid js-grid-row js-filter-container">
                                ...
                                <figure class="gallery-grid__item category-html category-js">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload"
                                            src="assets/img/MGInformática.jpeg" data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">MG Informática</h4>
                                        <span class="gallery-grid__category">MGInformatica.com.br</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/pereira.jpeg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Pereira</h4>
                                        <span class="gallery-grid__category">Pereira.com.br</span>
                                    </figcaption>
                                </figure>
                                ...
                                <figure class="gallery-grid__item category-wordpress">
                                    <div class="gallery-grid__image-wrap">
                                        <img class="gallery-grid__image cover lazyload" src="assets/img/Dellamama.jpeg"
                                            data-zoom alt="" />
                                    </div>
                                    <figcaption class="gallery-grid__caption">
                                        <h4 class="title title--h6 gallery-grid__title">Della Mama</h4>
                                        <span class="gallery-grid__category">Dellamama.com.br </span>
                                    </figcaption>
                                </figure>
                    ...
                    <!-- Footer -->
                    <footer class="footer">© Thomas Frankliyn Sena Santo</footer>
                </div>
            </div>
        </div>
    </main>
